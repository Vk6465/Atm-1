...
public class ATM{
    public static void main(String[]args){
        ...
        User aUser = theBank.addUser("Vinod","kumar","6465");
		User aUser1=theBank.addUser("pavan","Kalyan","6465");
		User aUser2=theBank.addUser("Vishnu","Varma","6465");
    ...
    public static void withdrawFunds(User theUser,Scanner sc){
        ...
        do{
            ...
            amount = sc.nextDouble();
            if(amount < 1000){
                System.out.println("Amount must be greater than Thousand");
            }else if(amount > actBal){
                System.out.println("Amount must not be greater than \n"+"balance of $"+actBal);
            }
        }while(amount < 10000 || amount>actBal);
        //gobble up rest of previous input
        sc.nextLine();
        //get a memo
